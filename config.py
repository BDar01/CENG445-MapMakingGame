...
MAPS = {
    "arena": {
        ...
        "objects": [(200, 300, Mine(None, 7, 30, 1500000)), (20, 45, Mine(None, 7, 30, 1500000)), (150, 285, Freezer(None, 5, 4, 900000))]
    },
    "labyrinth": {
        "type": "Labyrinth",
        ...
        "objects": [(480, 645, Mine(None, 7, 30, 1000000)), (28, 333, Mine(None, 10, 20, 4000000)), (800, 333,  Freezer(None, 15, 10, 800000)), (30, 100, Health(10, True))]
    }
}