...
print("Map 1 Line 3:", player1)
print(separator)
player1.drop("Mine")
print(map1)
print(player1.map.teams[player1.team])
print("Map 1 Line 4:", player1) #By looking to this line (comparing it with Map 1 Line 3) we can see it dropped the Mine and since the mine is in our posiiton and we didn't go away before it activates, it decreased our health value.
print(separator)
...
player1.move("E")
print("Map 1 Line 5:", "Global View Update", ([obj for obj in player1.map.objects_list if obj[2].__class__.__name__ == "Player" and obj[2].id == player1.id][0][0], 
...
print("Map 1 Line 6:", "Local View Update", ([obj for obj in player1.map.teams[player1.team].objects_list if obj[2].__class__.__name__ == "Player" and obj[2].id == player1.id][0][0], 
...
player1.move("SE") 
print(separator)
print("Map 1 Line 6:", ([obj for obj in player1.map.objects_list if obj[2].__class__.__name__ == "Player" and obj[2].id == player1.id][0][0], 
...
print(separator)
print("Map 1 Line 7:", ([obj for obj in map1.objects_list if obj[2].__class__.__name__ == "Player" and obj[2].id == player1.id][0][0], 
...
print("Map 1 Line 8:", player1) #Freezer dropped, freezed for a time interval, since we didn't move away before it gets activated.
print(separator)
